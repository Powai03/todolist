// Interface pour stocker les tâches
interface Task {
  title: string;
  description: string;
  deadline: string;
  status: "À faire" | "Terminée";
  username: string; // Ajouter le nom d'utilisateur à chaque tâche
}

// Fonction pour obtenir l'utilisateur depuis le localStorage
function getUserFromLocalStorage(): { username: string } | null {
...
function clearColumns(
  todoColumn: HTMLElement,
  completedColumn: HTMLElement
): void {
...
function markTaskAsCompleted(title: string): void {
